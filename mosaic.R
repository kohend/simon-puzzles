...
# The `mosaic' source file is a largely blank one, which contains
...
mosaic : [X] GTK COMMON mosaic nullgame-icon|no-icon
mosaic : [G] WINDOWS COMMON mosaic mosaic.res|noicon.res
